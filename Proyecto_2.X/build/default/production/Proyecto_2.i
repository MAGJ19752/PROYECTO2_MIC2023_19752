...
void __attribute__((picinterrupt(("")))) isr(void)
{
    ...
    if (ADIF)
    {
        ...
        {
            Posicion_S[0] = ADRESH;
            Ser1 = map(Posicion_S[0],0,255,160,650);
            PWM_duty(1,Ser1);
        ...
        {
            Posicion_S[1] = ADRESH;
            Ser2 = map(Posicion_S[1],0,255,160,650);
            PWM_duty(1,Ser2);
        ...
        {
            Posicion_S[2] = ADRESH;
            Ser3 = map(Posicion_S[2],0,255,160,650);
            PWM_duty(1,Ser3);
        ...
        {
            Posicion_S[3] = ADRESH;
            Ser4 = map(Posicion_S[3],0,255,160,650);
            PWM_duty(1,Ser4);
